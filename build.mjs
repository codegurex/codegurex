...
for (const file of ['index.html', 'styles.css', 'script.js', 'robots.txt', 'sitemap.xml', 'site.webmanifest', '_headers', 'og.png', 'og-light.png', 'og-milk-sea.png', 'og-violet-reference.png', 'CNAME', '.nojekyll']) {
