...
const homeCopy = {
  en: {
    ...
    "service-title-redteam": "Agentic AI Security",
    "service-title-cloud": "Cloud Security & Hardening",
    "service-title-infra": "Infrastructure Hardening",
    ...
    "service-api-details": "Explore API security ↗",
    "service-agent-details": "Explore agent security ↗",
    "service-infrastructure-details": "Explore infrastructure hardening ↗",
    "service-redteam":
      "Review agent goals, memory, identity, tools, permissions and human oversight.",
    "service-cloud":
      "Evaluate identity, exposure, storage, network and operational configuration according to the technology.",
    "service-infra":
      "Strengthen servers, containers, networks, secrets, logging and recovery controls.",
  ...
  es: {
    ...
    "service-title-redteam": "Seguridad de agentes de IA",
    "service-title-cloud": "Seguridad y hardening cloud",
    "service-title-infra": "Hardening de infraestructura",
    ...
    "service-api-details": "Conocer seguridad de APIs ↗",
    "service-agent-details": "Conocer seguridad de agentes ↗",
    "service-infrastructure-details": "Conocer hardening de infraestructura ↗",
    "service-redteam":
      "Revisión de objetivos, memoria, identidad, herramientas, permisos y supervisión humana.",
    "service-cloud":
      "Evaluación de identidad, exposición, almacenamiento, red y configuración operativa según la tecnología.",
    "service-infra":
      "Fortalecimiento de servidores, contenedores, redes, secretos, registros y recuperación.",
